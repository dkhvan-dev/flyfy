...
func (s *DomainService) Create(ctx context.Context, request DomainCreateRequest, actor string) (DomainResponse, error) {
...
func (s *DomainService) Update(ctx context.Context, id int64, request DomainUpdateRequest, actor string) (DomainResponse, error) {
