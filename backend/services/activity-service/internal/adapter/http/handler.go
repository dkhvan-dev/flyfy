...
func (h *Handler) writeAppError(w http.ResponseWriter, err error, fallback string) {
	...
	case errors.Is(err, app.ErrInvalidActivityID),
		...
		errors.Is(err, app.ErrActivityLocationCoordinatesRequired),
		errors.Is(err, app.ErrActivityLocationCoordinatesInvalid),
		errors.Is(err, app.ErrActivityLocationOfflineFieldsForbidden),
		errors.Is(err, app.ErrActivityLocationMeetingURLForbidden),
