...
func (c *Client) SendActivityNotification(
	ctx context.Context,
	...
	if err != nil {
		return fmt.Errorf("marshal activity notification: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("create activity notification request: %w", err)
	}
...
var _ port.ActivityNotificationGateway = (*Client)(nil)
