...
type AppConfig struct {
	Name string `env:"APP_NAME, default=tour-service"`
...
type DBConfig struct {
	...
	Name            string `env:"DB_NAME, default=tour_service_db"`
	User            string `env:"DB_USER, default=tour_service"`
	Password        string `env:"DB_PASSWORD, default=tour_secret_dev"`
