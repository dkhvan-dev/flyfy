...
var (
	...
	ErrExcursionPlaceRequired                 = errors.New("excursion must be based on an place")
	ErrCombinedExcursionRouteRequiresTwoStops = errors.New("combined excursion route requires at least two place stops")
