...
func (c *Client) SendExcursionNotification(
	ctx context.Context,
	...
	if err != nil {
		return fmt.Errorf("marshal excursion notification: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("create excursion notification request: %w", err)
	}
...
var _ port.ExcursionNotificationGateway = (*Client)(nil)
