...
type AppConfig struct {
	Name string `env:"APP_NAME, default=payment-service"`
...
type HTTPConfig struct {
	Port         int           `env:"HTTP_PORT, default=8091"`
...
type SecurityConfig struct {
	...
	RequireAuthenticatedRequests bool   `env:"REQUIRE_AUTHENTICATED_REQUESTS, default=true"`
