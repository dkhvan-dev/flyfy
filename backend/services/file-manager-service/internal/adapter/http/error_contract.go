...
var businessErrorMessages = map[string]map[string]string{
	"ru": {
		...
		app.ErrorCodeFileAlreadyBound:      "Файл уже привязан",
	...
	"en": {
		...
		app.ErrorCodeFileAlreadyBound:      "File is already bound",
	...
	"kk": {
		...
		app.ErrorCodeFileAlreadyBound:      "Файл бұрыннан байланыстырылған",
