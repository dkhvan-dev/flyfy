...
func NewRenderer() (*Renderer, error) {
	funcs := template.FuncMap{
		...
		"placeAdminTitle":             placeAdminTitleText,
		...
		"placeFeeDetailRows":          placeFeeDetailRows,
		"placeFeeItemRows":            placeFeeItemRows,
		"placeAccessOptionRows":       placeAccessOptionRows,
		"placePracticalNoteRows":      placePracticalNoteRows,
		"placeRecommendedItemRows":    placeRecommendedItemRows,
		"placeVisitReferenceOptions":  placeVisitReferenceOptions,
		"placeCategoryOptions":        placeCategoryOptions,
		"placeOptionalStringEquals":   placeOptionalStringEquals,
		"placeVisitBoolEquals":        placeVisitBoolEquals,
