...
-- - every attraction belongs to a reference-service/data/cities.json city_id;
...
WITH seed_base (
    ...
    VALUES
        ...
        ('ce5ca032-073b-4e4a-93d9-825a4e495574'::uuid, 'almaty', 'FOOD', 2, 'HOURS', 4.6, ARRAY['kazakhstan', 'almaty', 'green-bazaar', 'market', 'food', 'local-life', 'shopping']::text[]),
        ('bc934181-e9d9-4daa-9909-5f87a3169159'::uuid, 'almaty', 'SHOPPING', 3, 'HOURS', 4.3, ARRAY['kazakhstan', 'almaty', 'barakholka', 'market', 'shopping', 'local-life', 'bargain']::text[]),
...
WITH seed_translations (
    ...
    VALUES
        ('2eeacb52-12ef-4499-b229-05e52a199d22'::uuid, 'en', 'Kok Tobe Hill and Cable Car', 'A classic Almaty viewpoint reached by cable car or road, with city panoramas, cafes, small family attractions and evening lights above the foothills. It is a strong first-day stop because it explains the scale of the city at a glance.'),
        ...
        ('abede8f2-87db-4f12-bc3e-64e815a1f97e'::uuid, 'en', 'Nur Alem Future Energy Museum', 'The spherical EXPO-2017 pavilion turned into a multi-floor museum about future energy, science and the capital. It is a strong indoor attraction for families, tech-curious travelers and cold or windy days.'),
        ...
        ('b8847588-a922-42cf-94a2-ffcbf043922a'::uuid, 'en', 'Karavansaray Turkistan', 'A multifunctional tourist complex near the Yasawi mausoleum, styled as a Silk Road settlement with waterways, shopping, restaurants, shows and a flying theater. It is the strongest modern family attraction in Turkistan.'),
