...
type AppConfig struct {
	Name string `env:"APP_NAME, default=attraction-service"`
...
type PostgresConfig struct {
	...
	User     string `env:"POSTGRES_USER, default=attraction_service"`
	Password string `env:"POSTGRES_PASSWORD, default=attraction_secret_dev"`
	DB       string `env:"POSTGRES_DB, default=attraction_service_db"`
