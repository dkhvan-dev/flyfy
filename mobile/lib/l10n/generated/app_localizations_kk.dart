...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get serviceTravelChecklist => 'Сапар чек-листі';

  @override
  String get travelChecklistTitle => 'Сапарға дайындық';
  ...
  String get travelChecklistCtaSubtitle =>
      'Дайындық, маусым және багаж ережелері';

  @override
  String get travelChecklistOpen => 'Чек-листі ашу';

  @override
  String get travelChecklistPreviewAction => 'Алдын ала көру';

  @override
  String get travelChecklistPreviewMessage =>
      'Прогресс, еске салғыштар және өз тармақтарыңыз бар жеке чек-листі сақтау үшін экскурсияны брондаңыз.';

  @override
  String get travelChecklistPreviewDate => 'Брондау кезінде таңдалады';

  @override
  String get travelChecklistSampleTrip => 'Токио · шілде үлгісі';

  @override
  String get travelChecklistMissingContextTitle => 'Алдымен сапарды таңдаңыз';

  @override
  String get travelChecklistMissingContextMessage =>
      'Чек-лист бағыт, күндер, көлік және белсенділіктер бойынша есептеледі. Inflap кездейсоқ кеңес көрсетпеуі үшін оны броньнан, экскурсиядан немесе белсенділіктен ашыңыз.';

  @override
  String get travelChecklistMissingContextPrimaryAction => 'Экскурсия таңдау';

  @override
  String get travelChecklistMissingContextSecondaryAction =>
      'Белсенділіктерді ашу';

  @override
  String get travelChecklistQuickPrepTitle => 'Жылдам дайындық';

  @override
  String get travelChecklistQuickPrepMessage =>
      'Броньсыз дайындық жасаңыз: бағытты, күндерді, көлікті және белсенділіктерді көрсетіңіз — Inflap осы сапарға чек-лист құрады.';

  @override
  String get travelChecklistQuickPrepCountryCode => 'Ел';

  @override
  String get travelChecklistQuickPrepCountryCodeHint => 'Мысалы: Түркия';

  @override
  String get travelChecklistQuickPrepCity => 'Қала';

  @override
  String get travelChecklistQuickPrepCityHint => 'Мысалы: Ыстамбұл';

  @override
  String get travelChecklistQuickPrepStartDate => 'Басталуы';

  @override
  String get travelChecklistQuickPrepEndDate => 'Аяқталуы';

  @override
  String get travelChecklistQuickPrepTransportTitle => 'Қалай барасыз';

  @override
  String get travelChecklistQuickPrepActivitiesTitle => 'Не жоспарлайсыз';

  @override
  String get travelChecklistQuickPrepWithChildren => 'Балалармен барамын';

  @override
  String get travelChecklistQuickPrepSubmit => 'Дайындық жасау';

  @override
  String get travelChecklistQuickPrepDuplicateOpened =>
      'Бұл сапарға дайындық сізде бұрыннан бар.';

  @override
  String get travelChecklistQuickPrepCountryRequired => 'Елді таңдаңыз.';

  @override
  String get travelChecklistQuickPrepCountryInvalid =>
      'Елді тізімнен таңдаңыз немесе түсінікті ел атауын енгізіңіз.';

  @override
  String get travelChecklistQuickPrepCityRequired => 'Қаланы көрсетіңіз.';

  @override
  String get travelChecklistQuickPrepAlternativeTitle =>
      'Немесе чек-листі бар сценарийден ашыңыз';

  @override
  String get travelChecklistRecentTitle => 'Менің чек-листерім';

  @override
  String get travelChecklistRecentMessage =>
      'Соңғы жасалған дайындықтар осында көрінеді, сол сапар контекстін қайта ашуға болады.';

  @override
  String get travelChecklistRecentEmptyTitle => 'Әзірге чек-лист жоқ';

  @override
  String get travelChecklistRecentEmptyMessage =>
      'Ел, қала, күндер, көлік және белсенділіктер бойынша дайындық жасаңыз — чек-лист кейін осында пайда болады.';

  @override
  String get travelChecklistFilterAll => 'Барлығы';

  @override
  String get travelChecklistFilterUpcoming => 'Жақындары';

  @override
  String get travelChecklistFilterManual => 'Менің';

  @override
  String get travelChecklistFilterActivities => 'Белсенділіктер';

  @override
  String get travelChecklistFilterExcursions => 'Экскурсиялар';

  @override
  String get travelChecklistSectionUpcoming => 'Жақындағы дайындықтар';

  @override
  String get travelChecklistSectionManual => 'Менің жоспарларым';

  @override
  String get travelChecklistSectionPast => 'Өткендер';

  @override
  String get travelChecklistSourceManual => 'Менің чек-листім';

  @override
  String get travelChecklistSourceActivity => 'Белсенділік';

  @override
  String get travelChecklistSourceExcursion => 'Экскурсия';

  @override
  String get travelChecklistFilterEmptyTitle => 'Мұнда әзірге чек-лист жоқ';

  @override
  String get travelChecklistFilterEmptyMessage =>
      'Басқа сүзгіні таңдаңыз немесе жаңа дайындық жасаңыз.';

  @override
  String get travelChecklistContextTitle => 'Қай сапар үшін';

  @override
  String get travelChecklistContextDestination => 'Бағыт';

  @override
  String get travelChecklistContextDates => 'Күндер';

  @override
  String get travelChecklistContextTransport => 'Көлік';

  @override
  String get travelChecklistContextActivities => 'Белсенділіктер';

  @override
  String get travelChecklistContextTravelerProfile => 'Саяхатшылар';

  @override
  String get travelChecklistContextNoActivities => 'Арнайы белсенділік жоқ';

  @override
  String get travelChecklistContextWithChildren => 'Балалармен';

  @override
  String travelChecklistReminderDaysBefore(Object days) {
    return 'Сапарға $days күн қалғанда';
  }

  @override
  String get travelChecklistReminderOnTripDay => 'Сапар күні';
  ...
  @override
  String get travelChecklistActivityCulture => 'Мәдениет';

  @override
  String get travelChecklistActivityFood => 'Тамақ';

  @override
  String get travelChecklistActivityBeach => 'Жағажай';

  @override
  String get travelChecklistActivityMuseum => 'Музейлер';

  @override
  String get travelChecklistActivityShopping => 'Шопинг';

  @override
  String get travelChecklistActivityNightlife => 'Түнгі өмір';

  @override
  String get travelChecklistReadiness => 'Дайындық';

  @override
  String get travelChecklistSystemReadiness => 'Жүйелік дайындық';

  @override
  String travelChecklistPersonalProgress(int done, int total) {
    return 'Жеке тармақтар: $done/$total';
  }

  @override
  String get travelChecklistSeasonalProfile => 'Маусымдық профиль';
  ...
  String get travelChecklistItemsSearchEmpty =>
      'Бұл сұрау бойынша ештеңе табылмады.';

  @override
  String get travelChecklistAddItem => 'Тармақ қосу';

  @override
  String get travelChecklistCustomItemBadge => 'Өзімнің';

  @override
  String get travelChecklistCustomItemTitle => 'Не алу немесе жасау керек';

  @override
  String get travelChecklistCustomItemTitleHint => 'Мысалы: камера қуаттағышы';

  @override
  String get travelChecklistCustomItemNote => 'Ескертпе';

  @override
  String get travelChecklistCustomItemAdditional => 'Қосымша';

  @override
  String get travelChecklistCustomItemReuse => 'Болашақ чек-листерге қосу';

  @override
  String get travelChecklistCustomItemSave => 'Сақтау';

  @override
  String get travelChecklistCustomItemEdit => 'Өзгерту';

  @override
  String get travelChecklistCustomItemDelete => 'Жою';

  @override
  String get travelChecklistCustomItemCreated => 'Тармақ қосылды';

  @override
  String get travelChecklistCustomItemUpdated => 'Тармақ жаңартылды';

  @override
  String get travelChecklistCustomItemDeleted => 'Тармақ жойылды';

  @override
  String get travelChecklistCustomItemFailed =>
      'Жеке тармақ жаңартылмады. Кейінірек қайталаңыз.';
  ...
  @override
  String get travelChecklistCarrySearch => 'Алуға бола ма?';

  @override
  String get travelChecklistCarrySearchHint => 'Повербанк, сұйықтықтар, қайшы';

  @override
  String get travelChecklistSearch => 'Іздеу';

  @override
  String get travelChecklistNoCarryResults =>
      'Әзірге сәйкес ереже жоқ. Әуе компаниясын немесе ресми дереккөзді тексеріңіз.';

  @override
  String get travelChecklistCarryOn => 'Қол жүгі';

  @override
  String get travelChecklistCheckedBaggage => 'Тіркелген багаж';

  @override
  String get travelChecklistRetry => 'Қайталау';

  @override
  String get travelChecklistLoadFailed =>
      'Чек-лист жүктелмеді. Байланысты тексеріп, қайта көріңіз.';

  @override
  String get travelChecklistOfflineTitle => 'Офлайн көшірме';

  @override
  String get travelChecklistOfflineMessage =>
      'Соңғы сақталған чек-лист көрсетіліп тұр. Кейбір статустар байланыс қалпына келгенде синхрондалады.';

  @override
  String get travelChecklistReminders => 'Еске салулар';

  @override
  String get travelChecklistAssignToMe => 'Өзім аламын';

  @override
  String get travelChecklistAssignedToMe => 'Мен аламын';

  @override
  String get travelChecklistAssigned => 'Тағайындалған';

  @override
  String get travelChecklistAssignmentFailed =>
      'Тағайындау жаңартылмады. Кейінірек қайталаңыз.';

  @override
  String get travelChecklistFeedbackHelpful => 'Пайдалы болды';

  @override
  String get travelChecklistFeedbackNotHelpful => 'Пайдалы болмады';

  @override
  String get travelChecklistFeedbackAddNextTime => 'Келесі жолы қосу';

  @override
  String get travelChecklistFeedbackSent => 'Рақмет, ескереміз';

  @override
  String get travelChecklistFeedbackHelpfulSaved =>
      'Пікір сақталды: мұндай тармақтарды жиірек көрсетеміз.';

  @override
  String get travelChecklistFeedbackNotHelpfulSaved =>
      'Пікір сақталды: мұндай тармақтарды сирек көрсетеміз.';

  @override
  String get travelChecklistFeedbackAddNextTimeSaved =>
      'Пікір сақталды: болашақ чек-листерге қосамыз.';

  @override
  String get travelChecklistFeedbackFailed =>
      'Пікір жіберілмеді. Кейінірек қайталаңыз.';

  @override
  String get travelChecklistUnknown => 'Белгісіз';

  @override
  String get travelChecklistReadinessNotReady => 'Дайын емес';

  @override
  String get travelChecklistReadinessAtRisk => 'Қауіп бар';

  @override
  String get travelChecklistReadinessOnTrack => 'Жоспар бойынша';

  @override
  String get travelChecklistReadinessAlmostReady => 'Дерлік дайын';

  @override
  String get travelChecklistReadinessReady => 'Дайын';

  @override
  String get travelChecklistReadinessReadyWithWarnings => 'Ескертумен дайын';

  @override
  String get travelChecklistPriorityCritical => 'Өте маңызды';

  @override
  String get travelChecklistPriorityEssential => 'Қажетті';

  @override
  String get travelChecklistPriorityImportant => 'Маңызды';

  @override
  String get travelChecklistPriorityRecommended => 'Ұсынылады';

  @override
  String get travelChecklistPriorityOptional => 'Қосымша';

  @override
  String get travelChecklistTemperatureCold => 'Суық';

  @override
  String get travelChecklistTemperatureMild => 'Салқын';

  @override
  String get travelChecklistTemperatureWarm => 'Жылы';

  @override
  String get travelChecklistTemperatureHot => 'Ыстық';

  @override
  String get travelChecklistTemperatureVeryHot => 'Өте ыстық';

  @override
  String get travelChecklistPrecipitationDry => 'Құрғақ';

  @override
  String get travelChecklistPrecipitationOccasionalRain => 'Кейде жаңбыр';

  @override
  String get travelChecklistPrecipitationRainy => 'Жаңбырлы';

  @override
  String get travelChecklistPrecipitationMonsoon => 'Нөсер маусымы';

  @override
  String get travelChecklistPrecipitationSnow => 'Қар';

  @override
  String get travelChecklistSkySunny => 'Ашық';

  @override
  String get travelChecklistSkyMixed => 'Ауыспалы бұлт';

  @override
  String get travelChecklistSkyCloudy => 'Бұлтты';

  @override
  String get travelChecklistRiskCold => 'Суық';

  @override
  String get travelChecklistRiskDry => 'Құрғақ';

  @override
  String get travelChecklistRiskHeat => 'Ыстық';

  @override
  String get travelChecklistRiskHighUv => 'Жоғары UV';

  @override
  String get travelChecklistRiskHumid => 'Ылғалды';

  @override
  String get travelChecklistRiskIcy => 'Көктайғақ';

  @override
  String get travelChecklistRiskMixedWeather => 'Құбылмалы ауа райы';

  @override
  String get travelChecklistRiskRain => 'Жаңбыр';

  @override
  String get travelChecklistRiskWindy => 'Желді';

  @override
  String get travelChecklistCarryItemPowerBank => 'Повербанк';

  @override
  String get travelChecklistCarryItemTravelVisa => 'Виза / құжаттар';

  @override
  String get travelChecklistCarryItemLiquids => 'Сұйықтықтар';

  @override
  String get travelChecklistCarryItemSharpItems => 'Өткір заттар';

  @override
  String get travelChecklistCarryAllowed => 'Болады';

  @override
  String get travelChecklistCarryAllowedWithConditions => 'Шартпен болады';

  @override
  String get travelChecklistCarryProhibited => 'Тыйым салынған';

  @override
  String get travelChecklistCarryCheckAuthority => 'Ережені тексеріңіз';
  ...
  @override
  String get profileTimezoneSearchHint => 'Уақыт белдеуі, қала немесе UTC';
  ...
  @override
  String get profileCurrencySearchHint => 'Валюта, код немесе таңба';
  ...
  @override
  String get profileFollowersSearchHint => 'Фолловерлер';
  ...
  @override
  String get profileConnectionsSearchHint => 'Адамдар';
  ...
  @override
  String get activityInviteFriendsSearchHint => 'Достар';
  ...
  @override
  String get homeLocationSearchHint => 'Қала';
  ...
  @override
  String get locationFilterCitySearchHint => 'Қала';
  ...
  @override
  String get homeServicePlaces => 'Орындар';
  ...
  @override
  String get feedMySubscriptionsSearchHint => 'Жазылымдар';
  ...
  @override
  String get communityDiscoverySearchHint => 'Қауымдастықтар';
  ...
  @override
  String get placesSearchHint => 'Қайда барамыз?';

  @override
  String get placesLoadFailed => 'Орындарды жүктеу сәтсіз аяқталды';

  @override
  String get placesSeeAll => 'Барлығын көру';

  @override
  String get placesNoResults => 'Орындар табылмады';

  @override
  String get placesNoResultsSubtitle => 'Сүзгілерден басқа қаланы таңдаңыз.';

  @override
  String get placesFiltersTitle => 'Сүзгілер';

  @override
  String get placesSortLabel => 'Сұрыптау';

  @override
  String get placesSortRating => 'Рейтинг';

  @override
  String get placesSortDuration => 'Ұзақтығы';

  @override
  String get placesSortPrice => 'Баға';

  @override
  String get placeFilterClearAll => 'Барлығын тазалау';

  @override
  String get placeFilterCategoriesSection => 'Санаттар';

  @override
  String get placeFilterCategoryAll => 'Барлық орындар';

  @override
  String get placeFilterCategoryParks => 'Саябақтар';

  @override
  String get placeFilterCategoryMuseums => 'Мұражайлар';

  @override
  String get placeFilterCategoryNature => 'Табиғат';

  @override
  String get placeFilterCategoryArchitecture => 'Сәулет';

  @override
  String get placeFilterCategoryBeach => 'Жағажай';

  @override
  String get placeFilterCategoryTemple => 'Ғибадат орындары';

  @override
  String get placeFilterCategoryEntertainment => 'Ойын-сауық';

  @override
  String get placeFilterCategoryFood => 'Тағам';

  @override
  String get placeFilterCategoryMarket => 'Базар';

  @override
  String get placeFilterCategoryShopping => 'Шопинг';

  @override
  String get placeFilterCategoryOther => 'Басқа';

  @override
  String get placeFilterCategoryHistory => 'Тарих';

  @override
  String get placeFilterCategoryAdventure => 'Шытырман';

  @override
  String get placeFilterCountrySection => 'Ел';

  @override
  String get placeFilterCountryAll => 'Барлық елдер';

  @override
  String get placeFilterCountrySearchHint => 'Ел, код немесе телефон';

  @override
  String get placeFilterCountryNoResults => 'Ел табылмады';

  @override
  String get placeFilterMinRatingSection => 'Минимум рейтинг';

  @override
  String get placeFilterRatingAny => 'Кез келген';

  @override
  String get placeFilterDurationSection => 'Ұзақтығы';

  @override
  String get placeFilterDurationShort => 'Қысқа < 2 сағ';

  @override
  String get placeFilterDurationMedium => 'Орташа 2–5 сағ';

  @override
  String get placeFilterDurationFullDay => 'Толық күн 5 сағ+';

  @override
  String get placeFilterDurationMultiDay => 'Бірнеше күн';

  @override
  String get placeFilterRangeSection => 'Нақты ауқым';
  ...
  @override
  String get placeFilterRangeMinTick => '1 сағ';

  @override
  String get placeFilterRangeMaxTick => '12 сағ+';

  @override
  String get placeFilterPriceRangeSection => 'Баға ауқымы';
  ...
  @override
  String get placeFilterClear => 'Тазалау';

  @override
  String get placeMinPriceLabel => 'Мин. баға';

  @override
  String get placeMaxPriceLabel => 'Макс. баға';

  @override
  String get placePriceValidationError => 'Дұрыс баға енгізіңіз';
  ...
  @override
  String get placeHoursUnit => 'Сағат';

  @override
  String get placeDaysUnit => 'Күн';

  @override
  String get placeHoursUnitShort => 'сағ';

  @override
  String get placeDaysUnitShort => 'күн';
  ...
  @override
  String get placeDurationValidationError => 'Дұрыс ұзақтық енгізіңіз';
  ...
  @override
  String get placeDetailsLoadFailed => 'Орынды жүктеу сәтсіз аяқталды';

  @override
  String get placeDetailsTitle => 'Орын туралы';

  @override
  String get placeMustVisitBadge => 'Бару керек';

  @override
  String get placeStatRating => 'Рейтинг';

  @override
  String get placeStatDuration => 'Ұзақтығы';

  @override
  String get placeStatPrice => 'Баға';
  ...
  @override
  String get placeVisitTicketsLabel => 'Билеттер';

  @override
  String get placeVisitFreeEntry => 'Тегін немесе маусымға байланысты';

  @override
  String get placeVisitBookingRecommended => 'алдын ала брондаған дұрыс';

  @override
  String get placeVisitBestTimeLabel => 'Ең жақсы уақыт';

  @override
  String get placeVisitBestTimeEarlyMorning => 'Ерте таң';

  @override
  String get placeVisitBestTimeMorning => 'Таңертең';

  @override
  String get placeVisitBestTimeAfternoon => 'Күндіз';

  @override
  String get placeVisitBestTimeSunset => 'Күн батқанда';

  @override
  String get placeVisitBestTimeAnytime => 'Кез келген уақытта';

  @override
  String get placeVisitGoodForLabel => 'Кімге қолайлы';

  @override
  String get placeVisitAccessLabel => 'Қолжетімділік';

  @override
  String get placeVisitAccessGood => 'Жету ыңғайлы';

  @override
  String get placeVisitAccessLimited => 'Қолжетімділігі шектеулі';

  @override
  String get placeVisitAccessUnknown => 'Орнында нақтылаңыз';

  @override
  String get placeVisitSafetyLabel => 'Дайындық';

  @override
  String get placeVisitSafetyCheckWeather => 'Ауа райын тексеріңіз';

  @override
  String get placeVisitSafetyBringWater => 'Су алыңыз';

  @override
  String get placeVisitSafetyCheckHours => 'Жұмыс уақытын тексеріңіз';

  @override
  String get placeVisitAudienceCouples => 'Жұптар';

  @override
  String get placeVisitAudienceWellness => 'Сауықтыру';
  ...
  @override
  String get placeNoReviews => 'Әзірге пікір жоқ. Бірінші болыңыз!';

  @override
  String get placeAddReview => 'Пікір қалдыру';

  @override
  String get placeReviewSheetTitle => 'Әсеріңізбен бөлісіңіз';

  @override
  String get placeReviewRatingLabel => 'Баға';

  @override
  String get placeReviewCommentLabel => 'Пікір';
  ...
  @override
  String get placeReviewSubmit => 'Пікірді жариялау';

  @override
  String get placeReviewSubmitting => 'Жариялануда...';
  ...
  @override
  String get placeReviewPickFailed => 'Файлды тіркеу мүмкін болмады';

  @override
  String get placeReviewMediaTooLarge => 'Файл тым үлкен';

  @override
  String get placeReviewUnsupportedFormat => 'Файл пішімі қолдау көрсетілмейді';

  @override
  String get placeReviewSubmitFailed => 'Пікірді жариялау мүмкін болмады';

  @override
  String get placeReviewSubmitSuccess => 'Пікір жарияланды';

  @override
  String get placeReviewCommentRequired => 'Қысқа пікір жазыңыз';

  @override
  String get placeReviewRemoveMedia => 'Файлды жою';

  @override
  String get placeReviewVideoPreview => 'Видео';

  @override
  String get placeFindExcursions => 'Экскурсиялар табу';

  @override
  String get placeMapLink => 'Картадан көру';
  ...
  @override
  String get placeBackTooltip => 'Артқа';

  @override
  String get placeNotificationsTooltip => 'Хабарландырулар';

  @override
  String get placeBookmarkTooltip => 'Орынды сақтау';

  @override
  String get placeTagFamilyLabel => 'Отбасына қолайлы';

  @override
  String get placeTagFamilySubtitle => 'Барлық жасқа жарайды';

  @override
  String get placeTagSunsetLabel => 'Күн батқанда жақсы';

  @override
  String get placeTagSunsetSubtitle => 'Әдемі кешкі көріністер';

  @override
  String get placeTagAccessibilityLabel => 'Қолжетімділік';

  @override
  String get placeTagAccessibilitySubtitle => 'Арбаға қолайлы';

  @override
  String get placeTagDiningLabel => 'Мейрамханалар';

  @override
  String get placeTagDiningSubtitle => 'Гастрономиялық орындар';

  @override
  String get placeTagOutdoorLabel => 'Табиғатта';

  @override
  String get placeTagOutdoorSubtitle => 'Таза ауа мен көріністер';

  @override
  String get placeTagPhotoLabel => 'Фото орын';

  @override
  String get placeTagPhotoSubtitle => 'Есте қаларлық кадрлар';

  @override
  String get placeTagHistoryLabel => 'Тарихи';

  @override
  String get placeTagHistorySubtitle => 'Бай мәдени мұра';

  @override
  String get placeTagAdventureLabel => 'Шытырман';

  @override
  String get placeTagAdventureSubtitle => 'Белсенді әсерлер';

  @override
  String get placeTagUniqueSubtitle => 'Ерекше әсер';
  ...
  @override
  String get excursionsSearchHint => 'Экскурсиялар мен әсерлер';
  ...
  @override
  String get excursionsFilterCountrySearchHint => 'Ел, код немесе телефон';
  ...
  @override
  String get excursionsFilterLanguageSearchHint => 'Тіл немесе код';
  ...
  String get excursionsNoPlaceExcursionsTitle =>
      'Бұл орын бойынша экскурсиялар әзірге жоқ';

  @override
  String get excursionsNoPlaceExcursionsSubtitle =>
      'Басқа қолжетімді экскурсияларды көрсетіп тұрмыз. Гидтер осы орынға маршрут қосқанда, ол осында пайда болады.';

  @override
  String get guidesTitle => 'Гидтер';

  @override
  String get guidesSearchHint => 'Гидтер';
  ...
  @override
  String get guidesFilterCountrySearchHint => 'Ел, код немесе телефон';
  ...
  @override
  String get guidesFilterLanguageSearchHint => 'Тіл немесе код';
  ...
  @override
  String get excursionDetailsOffersSearchHint => 'Гидтер мен ұсыныстар';
  ...
  @override
  String get excursionDetailsOffersLanguageSearchHint => 'Тіл немесе код';
  ...
  @override
  String get excursionBookingChecklistAddedTitle => 'Сапарға дайындық дайын';

  @override
  String get excursionBookingChecklistAddedMessage =>
      'Inflap осы бронь үшін чек-лист дайындады: құжаттар, ауа райы, багаж ережелері және белсенділікке қажет нәрселер.';

  @override
  String get excursionBookingOpenChecklist => 'Чек-листті ашу';
  ...
  String get createExcursionCoverUploadHint =>
      'JPG, PNG немесе WEBP. Орын таңдалса, өз суретіңізді жүктемейінше оның суреті қолданылады.';

  @override
  String get createExcursionSelectedLandmark => 'Орын';
  ...
  @override
  String get createExcursionLandmarkValidation => 'Орынды таңдаңыз';
  ...
  String get createExcursionManualLocationHint =>
      'Өз локацияңызды енгізуге немесе осы елдегі орынды таңдауға болады.';

  @override
  String get createExcursionLocationLockedByPlace =>
      'Локация орындар анықтамалығынан алынды. Өзгерту үшін басқа орынды таңдаңыз.';

  @override
  String get createExcursionPlaceCatalogHint =>
      'Таңдалған елдің орындар каталогы';

  @override
  String get createExcursionPlaceCatalogSource => 'Орындар каталогынан';

  @override
  String get createExcursionSinglePlaceMode => 'Бір орын';
  ...
  @override
  String get excursionSelectLocationCountrySearchHint => 'Елдер';
  ...
  @override
  String get excursionSelectLocationPlaceSection => 'Орынды таңдаңыз';

  @override
  String get excursionSelectLocationPlaceSearchHint => 'Орындар';
  ...
  @override
  String get createExcursionDiscardTitle => 'Сақтамай шығасыз ба?';
  ...
  String get createExcursionModeSwitchDescription =>
      'Қазіргі нұсқаның деректері тазаланады. Экскурсияның қалған мәліметтері сақталады.';

  @override
  String get createExcursionModeSwitchCancel => 'Осы жерде қалу';

  @override
  String get createExcursionModeSwitchConfirm => 'Өзгерту және тазарту';
  ...
  @override
  String get createExcursionLanguagesSearchHint => 'Тіл немесе код';
  ...
  @override
  String get myExcursionsSearchHint => 'Экскурсиялар, гидтер және қалалар';
  ...
  String get guideDashboardSearchHint =>
      'Ұсыныстар, қонақтар, қалалар және күндер';
  ...
  String get activitiesSearchHint =>
      'Белсенділіктер, ұйымдастырушылар, қалалар';
  ...
  @override
  String get activitiesFilterCountrySearchHint => 'Ел, код немесе телефон';
  ...
  @override
  String get storySearchHint => 'Посттар, авторлар немесе орындар';

  @override
  String get storySearchCompactHint => 'Посттар';
  ...
  @override
  String get storyFilterCountrySearchHint => 'Ел, код немесе телефон';
  ...
  @override
  String get storyCountryHint => 'Ел';

  @override
  String get storyCityHint => 'Қала';
  ...
  @override
  String get storyEditorTitle => 'Пост редакторы';
  ...
  String get storyEditorDiscardChangesTitle =>
      'Пост өзгерістерінен бас тарту керек пе?';
  ...
  @override
  String get chatListSearchHint => 'Чаттар';
  ...
  @override
  String get stickersSearchHint => 'Стикерлер';
  ...
  @override
  String get notificationsCategoryChecklist => 'Чек-листер';
  ...
  String get notificationsActivityParticipantWaitlistedTitle =>
      'Қатысушы күту тізіміне қосылды';

  @override
  String get notificationsActivityParticipantWaitlistedBody =>
      'Күту тізімін басқару үшін белсенділікті ашыңыз.';

  @override
  String get notificationsActivityParticipantLeftTitle =>
      'Қатысушы белсенділіктен шықты';

  @override
  String get notificationsActivityParticipantLeftBody =>
      'Ағымдағы қатысушылар тізімін тексеру үшін белсенділікті ашыңыз.';

  @override
  String get notificationsActivityLateCancellationTitle => 'Кеш бас тарту';

  @override
  String get notificationsActivityLateCancellationBody =>
      'Қатысушы басталу уақытына жақын кезде бас тартты.';

  @override
  String get notificationsActivityCancelledTitle => 'Белсенділік тоқтатылды';

  @override
  String notificationsActivityCancelledBody(Object activity) {
    return '«$activity» белсенділігі тоқтатылды.';
  }

  @override
  String get notificationsActivityCancelledBodyGeneric =>
      'Бұл белсенділік тоқтатылды.';

  @override
  String get notificationsActivityConfirmedTitle => 'Белсенділік расталды';

  @override
  String get notificationsActivityConfirmedBody =>
      'Соңғы мәліметтерді көру үшін белсенділікті ашыңыз.';

  @override
  String get notificationsActivityCompletedTitle => 'Белсенділік аяқталды';

  @override
  String get notificationsActivityCompletedBody =>
      'Енді әсеріңіз туралы пікір қалдыра аласыз.';

  @override
  String get notificationsExcursionBookingCreatedTitle =>
      'Жаңа экскурсия броні';

  @override
  String get notificationsExcursionBookingCreatedBody =>
      'Брон мәліметтерін көру үшін гид кабинетін ашыңыз.';

  @override
  String get notificationsExcursionBookingCancelledTitle =>
      'Экскурсия броні тоқтатылды';

  @override
  String get notificationsExcursionBookingCancelledBody =>
      'Саяхатшы бұл экскурсиядан бас тартты.';

  @override
  String get notificationsExcursionGuestsUpdatedTitle => 'Қонақ саны өзгерді';

  @override
  String get notificationsExcursionGuestsUpdatedBody =>
      'Жаңартылған бронды тексеру үшін гид кабинетін ашыңыз.';

  @override
  String get notificationsExcursionAttendanceTitle => 'Қонақ белгіленді';

  @override
  String get notificationsExcursionAttendanceBody =>
      'Саяхатшы осы экскурсияға келгенін белгіледі.';

  @override
  String get notificationsExcursionCancelledTitle => 'Экскурсия тоқтатылды';

  @override
  String get notificationsExcursionCancelledBody =>
      'Гид бұл экскурсияны тоқтатты.';

  @override
  String get notificationsExcursionStartsSoonTitle =>
      'Экскурсия жақында басталады';

  @override
  String get notificationsExcursionStartsSoonBody =>
      'Брондау терезесі жабылды. Қонақтарды тексеру үшін экскурсияны ашыңыз.';

  @override
  String get notificationsExcursionCompletedTitle => 'Экскурсия қалай өтті?';

  @override
  String get notificationsExcursionCompletedBody =>
      'Экскурсия аяқталды. Енді пікір қалдыра аласыз.';

  @override
  String get notificationsExcursionPublishedTitle => 'Экскурсия жарияланды';

  @override
  String get notificationsExcursionPublishedBody =>
      'Экскурсияңыз енді саяхатшыларға көрінеді.';

  @override
  String get notificationsExcursionRejectedTitle => 'Экскурсияны түзету керек';

  @override
  String get notificationsExcursionRejectedBody =>
      'Модерация ескертулерін көру үшін гид кабинетін ашыңыз.';
