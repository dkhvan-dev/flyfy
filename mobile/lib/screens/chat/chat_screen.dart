...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _showDirectChatActions(
    ...
    final shouldBlock = await showAppModalBottomSheet<bool>(
      ...
      builder: (sheetContext) {
        return SafeArea(
          child: Padding(
            padding: AppEdgeInsets.symmetric(vertical: _scale(context, 8)),
            child: ListTile(
              leading: Icon(
  ...
  List<StickerVm> _prioritizedStickerWarmupList(List<StickerPackVm> packs) {
    ...
    return packs
        ...
        .where((sticker) => sticker.displayFileId.isNotEmpty)
        .toList(growable: false);
  }
        ...
        return SafeArea(
          ...
          child: ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: Padding(
                padding: const AppEdgeInsets.fromLTRB(24, 20, 24, 24),
                child: Column(
...
class _ReplySwipeBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Align(
      alignment: Alignment.centerLeft,
      child: Padding(
        padding: AppEdgeInsets.only(left: _scale(context, 10)),
        child: Container(
...
class _ReactionUserTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      contentPadding: AppEdgeInsets.symmetric(vertical: _scale(context, 8)),
      leading: _ChatAvatar(
      ...
      subtitle: Padding(
        padding: AppEdgeInsets.only(top: _scale(context, 3)),
        child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: ConstrainedBox(
        constraints: BoxConstraints(maxHeight: maxHeight),
        child: Padding(
          padding: AppEdgeInsets.fromLTRB(18, 12, 18, 18 + bottom),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            if (previewUrl != null) ...[
              ClipRRect(
                borderRadius: AppBorderRadius.circular(_scale(context, 10)),
                child: Image.network(
                  previewUrl,
      ...
      builder: (context, snapshot) {
        ...
        if (asset.isLottieSticker) {
          return Lottie.memory(
            ...
            errorBuilder: (context, error, stackTrace) =>
                _StickerPlaceholder(emoji: fallbackEmoji),
            fit: fit,
        ...
        return _StickerPlaceholder(emoji: fallbackEmoji);
      },
    );
  }
}
...
class _StickerPlaceholder extends StatelessWidget {
  const _StickerPlaceholder({this.loading = false, this.emoji = ''});
...
class _StickerImageCache {
  ...
  static Future<_StickerAsset?> assetFor(String fileId) {
    ...
    final load = () async {
      try {
        final content = await _fileApi.downloadStickerContent(normalizedFileId);
...
class _StickerGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (stickers.isEmpty) {
      return Center(
        child: Padding(
          padding: AppEdgeInsets.symmetric(horizontal: _scale(context, 24)),
          child: Text(
