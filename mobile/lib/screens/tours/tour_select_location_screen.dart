...
class TourLocationSelection {
  const TourLocationSelection({
    required this.id,
    required this.name,
...
class TourLocationPickerArgs {
  const TourLocationPickerArgs({
    required this.countryCode,
    this.initialSelection,
  });

  final String countryCode;
  final TourLocationSelection? initialSelection;
}

class TourSelectLocationScreen extends StatefulWidget {
  const TourSelectLocationScreen({
    super.key,
    required this.countryCode,
    this.initialSelection,
    this.api,
  ...
  @override
  State<TourSelectLocationScreen> createState() =>
      _TourSelectLocationScreenState();
}

class _TourSelectLocationScreenState extends State<TourSelectLocationScreen> {
  ...
  TourLocationSelection? _selectedLocation;
  ...
  void _selectAttraction(AttractionVm attraction) {
    setState(() {
      _selectedLocation = TourLocationSelection.fromAttraction(attraction);
    });
  }
  ...
  void _confirm() {
    ...
    context.pop<TourLocationSelection>(selected);
  }
              ...
              child: Stack(
                children: [
                  Column(
                    children: [
                      _LocationTopBar(
                        title: l10n.tourSelectLocationTitle,
                        onBack: () => context.pop(),
                      ),
                      Expanded(
                          ...
                          child: ListView(
                            ...
                            children: [
                              _LocationSectionTitle(
                                title: l10n.tourSelectLocationAttractionSection,
                              ),
                              const SizedBox(height: 20),
                              _LocationSearchField(
                                controller: _attractionSearchCtrl,
                                hintText:
                                    l10n.tourSelectLocationAttractionSearchHint,
                                trailing: IconButton(
                              ...
                              Text(
                                l10n.tourSelectLocationPageCaption(
                                  _currentPage,
                                  _totalPages,
                                ),
...
class _SelectButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: Text(
        selected ? l10n.tourSelectLocationSelected : l10n.select,
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
        style: TextStyle(
