...
class _GuideReviewsScreenState extends State<GuideReviewsScreen> {
  ...
  Future<ExcursionReviewsPage>? _reviewsFuture;
  String _loadedGuideUserId = '';

  Future<ExcursionReviewsPage> _loadReviews(String guideUserId) {
  ...
  Future<void> _refresh(String guideUserId) async {
    final future = _loadReviews(guideUserId);
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    if (canLoadReviews && _loadedGuideUserId != guideUserId) {
      _loadedGuideUserId = guideUserId;
      _reviewsFuture = _loadReviews(guideUserId);
    }
            ...
            child: ConstrainedBox(
              ...
              child: RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    AppListScreenHeader(
                      title: l10n.profileGuideReviewsLatestTitle,
