...
void main() {
  test(
    ...
    () {
      ...
      expect(activity.allowsParticipantInvites, isTrue);
    },
  );

  test('create and update requests send city taxonomy and invite fields', () {
    ...
    expect(updateJson['allowsParticipantInvites'], isFalse);
  });
}
