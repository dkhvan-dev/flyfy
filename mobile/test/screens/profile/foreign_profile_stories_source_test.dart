...
void main() {
  test('foreign profile renders popular stories and links to user stories',
      () async {
    ...
    final apiSource =
        await File('lib/core/network/story_api.dart').readAsString();
    ...
    expect(apiSource, contains('Future<List<StoryVm>> getUserPopularStories'));
