...
void main() {
  test('excursion booking screen follows the booking reference structure',
      () async {
    final source =
        await File('lib/screens/excursions/excursion_booking_screen.dart')
            .readAsString();
  ...
  test('router exposes protected booking route before public details route',
    ...
    final bookingRouteIndex =
        routerSource.indexOf("path: '/excursions/:excursionId/booking'");
    final detailsRouteIndex =
        routerSource.indexOf("path: '/excursions/:excursionId'");
