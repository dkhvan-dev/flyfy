...
void main() {
  test('shared city filter uses reference city search and localized preview',
      () async {
  ...
  test('city filter localization replaces country wording in discover sheets',
      () async {
    ...
    expect(ruArb, contains('"locationFilterCityNoResults": "Город не найден"'));
