...
const (
	...
	UserService_FilterFollowingUserIds_FullMethodName          = "/user.v1.UserService/FilterFollowingUserIds"
...
type UserServiceClient interface {
	...
	FilterFollowingUserIds(ctx context.Context, in *FilterFollowingUserIdsRequest, opts ...grpc.CallOption) (*FilterFollowingUserIdsResponse, error)
...
func (c *userServiceClient) FilterFollowingUserIds(ctx context.Context, in *FilterFollowingUserIdsRequest, opts ...grpc.CallOption) (*FilterFollowingUserIdsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FilterFollowingUserIdsResponse)
	err := c.cc.Invoke(ctx, UserService_FilterFollowingUserIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	FilterFollowingUserIds(context.Context, *FilterFollowingUserIdsRequest) (*FilterFollowingUserIdsResponse, error)
...
func (UnimplementedUserServiceServer) FilterFollowingUserIds(context.Context, *FilterFollowingUserIdsRequest) (*FilterFollowingUserIdsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FilterFollowingUserIds not implemented")
}
...
func _UserService_FilterFollowingUserIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterFollowingUserIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).FilterFollowingUserIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_FilterFollowingUserIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FilterFollowingUserIds(ctx, req.(*FilterFollowingUserIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FilterFollowingUserIds",
			Handler:    _UserService_FilterFollowingUserIds_Handler,
		},
		{
