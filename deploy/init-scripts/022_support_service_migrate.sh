...
echo "Running pending support-service migrations..."

: "${PGHOST:=support-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/support-service/*.up.sql; do
...
echo "Pending support-service migrations applied"
