...
echo "Running pending feed-service migrations..."

: "${PGHOST:=feed-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/feed-service/*.up.sql; do
...
echo "Pending feed-service migrations applied"
