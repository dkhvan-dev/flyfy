...
echo "Running pending switches-service migrations..."

: "${PGHOST:=switches-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/switches-service/*.up.sql; do
...
echo "Pending switches-service migrations applied"
