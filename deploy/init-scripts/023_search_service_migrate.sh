...
echo "Running pending search-service migrations..."

: "${PGHOST:=search-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/search-service/*.up.sql; do
...
echo "Pending search-service migrations applied"
