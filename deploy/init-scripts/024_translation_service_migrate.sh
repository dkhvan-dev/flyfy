...
echo "Running pending translation-service migrations..."

: "${PGHOST:=translation-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/translation-service/*.up.sql; do
...
echo "Pending translation-service migrations applied"
