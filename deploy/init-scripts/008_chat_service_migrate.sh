...
echo "Running pending chat-service migrations..."

: "${PGHOST:=chat-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/chat-service/*.up.sql; do
...
echo "Pending chat-service migrations applied"
