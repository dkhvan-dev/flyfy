...
echo "Running pending checklist-service migrations..."

: "${PGHOST:=checklist-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/checklist-service/*.up.sql; do
...
echo "Pending checklist-service migrations applied"
