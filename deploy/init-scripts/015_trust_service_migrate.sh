...
echo "Running pending trust-service migrations..."

: "${PGHOST:=trust-postgres}"
: "${PGPORT:=5432}"
...
for file in /migrations/trust-service/*.up.sql; do
...
echo "Pending trust-service migrations applied"
